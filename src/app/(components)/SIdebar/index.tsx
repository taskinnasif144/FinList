...
import { AlertCircle, AlertOctagon, AlertTriangle, Briefcase, ChevronDown, ChevronUp, Home, HomeIcon, Icon, Layers3, Lock, LucideIcon, Search, Settings, ShieldAlert, User, Users, X } from 'lucide-react';
    ...
    <div className={sidebarClassNames}>
      <div>
        ...
        <nav>
         ...
         <SidebarLinks href='/users' label='Users' icon={User} />
